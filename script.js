...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+Priority+Allocation+Access+for+TAYAL+ENVOGUE+2.0+and+the+launch-phase+pricing.%0A%0A' +
  ...
  if (heroForm) {
    heroForm.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+the+TAYAL+ENVOGUE+2.0+launch+price+and+Priority+Allocation+Access.%0A%0A' +
        'Name%3A+' + encodeURIComponent(name) + '%0A' +
        'Mobile%3A+%2B91+' + encodeURIComponent(mob);
